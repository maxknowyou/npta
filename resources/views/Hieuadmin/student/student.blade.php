...
<script>
    ...
    $("#card").on("change",function(){
        ChangeEnddayInAddModal($(this).children("option:selected").data("month"));
    })
    $("#cardedit").on("change",function(){
        ChangeEnddayInEditModal($(this).children("option:selected").data("month"));
    })
